/** @typedef {Object<string, Object<string, Object | string>>} Translations */
...
class Translator extends EventTarget {
    ...
    if (translation) {
      ...
      if (translation.format) {
        if (translation instanceof RelativeTimeFormat) {
          return translation.format(...interpolation);
        }
        return translation.format(interpolation);
      }
    }
   ...
   * @returns {Translator}
   */
  static initialize(options, symbol = Symbol.for('c-translator')) {
