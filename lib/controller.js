...
class Controller extends LitElement {
   ...
   *
   * @param {string} name name of the route as defined in `Controller#routes`
   * @param {Object} params
  ...
  /**
   * Checks the current URL against routes and invokes `Controller#route` if an appropriate route is found.
   *
   * @private
   * @returns {void}
   */
